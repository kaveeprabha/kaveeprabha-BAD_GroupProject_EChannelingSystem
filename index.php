        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets//img//logoSuwasetha.png" height="40px"></a>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>About doctor</h4>
                            <p>Dr.Nathasha singhawansha</p>
                            <p>Registered Medical Officer</p>
                            <p>SLMC Reg. No. 2481</p>
                            <p>MBbs Colombo</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
